...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling" labelsEnabled="1" version="3.14.1-Pi">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="0" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Italic" blendMode="0" textOrientation="horizontal" fontWordSpacing="0" textColor="194,29,172,255" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" fontWeight="50" fontUnderline="0" fontSize="8" fontCapitals="0" fontItalic="1" fieldName="PP3_slaved" fontFamily="Arial" fontSizeUnit="Point" allowHtml="0" textOpacity="1" fontStrikeout="0" fontKerning="1">
